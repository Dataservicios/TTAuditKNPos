...
public class FotoInteriorActivity extends Activity {

    private Activity MyActivity = this ;
    private static final String LOG_TAG = FotoInteriorActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foto_interior);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setTitle("Foto Interior");
    ...
    class loadPoll extends AsyncTask<Void , Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                intent = new Intent(MyActivity, FotoVoucherFinalActivity.class);
