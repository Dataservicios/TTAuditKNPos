...
public class ModeloPosActivity extends Activity {

    private Activity MyActivity = this ;
    private static final String LOG_TAG = ModeloPosActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modelo_pos);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setTitle("Modelos Pos");
    ...
    class loadPoll extends AsyncTask<Void , Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                    ...
                    Intent intent;
                    intent = new Intent(MyActivity, NumeroTerminalesActivity.class);
