...
public class FotoVoucherInicioActivity extends Activity {

    private Activity MyActivity = this ;
    private static final String LOG_TAG = FotoVoucherInicioActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foto_voucher_inicio);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setTitle("Foto Voucher");
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                // loadLoginActivity();
                    ...
                    intent = new Intent(MyActivity, FotosPosActivity.class);
