...
public class FotosPosActivity extends Activity {
    private Activity MyActivity = this ;
    private static final String LOG_TAG = FotosPosActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fotos_pos);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setTitle("Foto POS");
    ...
    class loadPoll extends AsyncTask<Void , Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                intent = new Intent(MyActivity, FotoStikerPosActivity.class);
