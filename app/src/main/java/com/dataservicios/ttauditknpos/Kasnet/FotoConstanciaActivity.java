...
public class FotoConstanciaActivity extends Activity {
    private Activity MyActivity = this ;
    private static final String LOG_TAG = FotoConstanciaActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foto_constancia);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setTitle("Foto de constancia de instalación");
