...
public class NumeroTerminalesActivity extends Activity {
    private Activity MyActivity = this ;
    private static final String LOG_TAG = NumeroTerminalesActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numero_terminales);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setTitle("Terminales");
    ...
    class loadPoll extends AsyncTask<Void , Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                Intent intent;
                intent = new Intent(MyActivity, FotoInteriorActivity.class);
