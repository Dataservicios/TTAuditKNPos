...
public class FotoVoucherFinalActivity extends Activity {

    private Activity MyActivity = this ;
    private static final String LOG_TAG = FotoVoucherFinalActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foto_voucher_final);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setTitle("Foto Voucher Final");
    ...
    class loadPoll extends AsyncTask<Void , Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                intent = new Intent(MyActivity, FotoConstanciaActivity.class);
